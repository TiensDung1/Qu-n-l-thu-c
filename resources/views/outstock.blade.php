...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Hết hàng</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('products')}}">Dược phẩm</a></li>
					...
					<table id="datatable-export" class=" table table-hover table-center mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="btn btn-sm bg-danger-light">Chỉ có {{$product->quantity}}</span></td>
