...
<div class="col-sm-7 col-auto">
	<h3 class="page-title">Loại thuốc</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Bảng điều khiển</a></li>
		<li class="breadcrumb-item active">Loại thuốc</li>
	</ul>
</div>
<div class="col-sm-5 col">
	<a href="#add_categories" data-toggle="modal" class="btn btn-primary float-right mt-2">Thêm loại thuốc</a>
</div>
					...
					<table id="category-table" class="datatable table table-striped table-bordered table-hover table-center mb-0">
						<thead>
							<tr style="boder:1px solid black;">
								<th>Tên thuốc</th>
								<th>Ngày cập nhật</th>
								<th class="text-center action-btn">Quản lý</th>
							</tr>
						</thead>
						<tbody>
								...
								<td class="text-center">
									<div class="actions">
										<a data-id="{{$category->id}}" data-name="{{$category->name}}" class="btn btn-sm bg-success-light editbtn " data-toggle="modal" href="javascript:void(0)">
											<i class="fe fe-pencil"></i> Sửa chữa
										</a>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Thêm loại thuốc</h5>
