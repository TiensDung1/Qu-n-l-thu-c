...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Chỉnh sửa giao dịch mua</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Bảng điều khiển</a></li>
		<li class="breadcrumb-item active">Chỉnh sửa giao dịch mua</li>
	</ul>
</div>
@endpush
			...
			<div class="card-body custom-edit-service">
				...
				<form method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('edit-purchase',$purchase)}}">
					...
					<div class="submit-section">
						<button class="btn btn-primary submit-btn" type="submit" >Cập nhật</button>
					</div>
				</form>
				<!-- /Add Medicine -->
