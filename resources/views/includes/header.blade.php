...
<div class="header">
	...
	<div class="header-left">
		<a href="{{route('dashboard')}}" class="logo">
			<img src="@if(!empty(AppSettings::get('logo'))) {{asset('storage/'.AppSettings::get('logo'))}} @else{{asset('assets/img/logo9.png')}} @endif" alt="Logo">
		</a>
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown noti-dropdown">
			...
			<div class="dropdown-menu notifications">
				<div class="topnav-dropdown-header">
					...
					<a href="{{route('mark-as-read')}}" class="clear-noti">Đánh dấu tất cả như đã đọc </a>
				</div>
								...
								<a href="{{route('read')}}">
									<div class="media">
										...
										<div class="media-body">
											<h6 class="text-danger">Cảnh báo hàng tồn kho</h6>
											<p class="noti-details">
												<span class="noti-title">{{$notification->data['product_name']}} Chỉ còn {{$notification->data['quantity']}} lại.</span>
												<span>Vui lòng cập nhật số lượng mua</span>
											</p>
		...
		<li class="nav-item dropdown has-arrow">
			...
			<div class="dropdown-menu">
				...
				<a class="dropdown-item" href="{{route('profile')}}">Thông tin của tôi</a>
				@can('view-settings')<a class="dropdown-item" href="{{route('settings')}}">Cài đặt</a>@endcan
				@can('backup-app')
				<a class="dropdown-item" href="{{route('backup-app')}}">Ứng dụng sao lưu</a>
				@endcan
				@can('backup-db')
				<a class="dropdown-item" href="{{route('backup-db')}}">Cơ sở dữ liệu sao lưu</a>
				@endcan
