...
<div class="col-sm-7 col-auto">
	<h3 class="page-title">Xuất thuốc</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Bảng điều khiển</a></li>
		<li class="breadcrumb-item active">Xuất thuốc</li>
	</ul>
</div>
@can('create-sales')
<div class="col-sm-5 col">
	<a href="#add_sales" data-toggle="modal" class="btn btn-primary float-right mt-2">Thêm thuốc</a>
</div>
@endcan
@endpush
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Bán thuốc</h5>
...
<div class="modal fade" id="edit_sale" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Chỉnh sửa thuốc đã bán</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
