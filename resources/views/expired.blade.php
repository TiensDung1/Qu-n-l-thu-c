...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Hết hạn</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('products')}}">Các sản phẩm thuốc</a></li>
					...
					<table id="datatable-export" class="table table-striped table-bordered table-hover table-center mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="btn btn-sm bg-danger-light">SẢN PHẨM ĐÃ HẾT HẠN</span></td>
								<td>
									<div class="actions">
										<a class="btn btn-sm bg-success-light" href="{{route('edit-product',$product)}}">
											<i class="fe fe-pencil"></i> Sủa
										</a>
